...
│   │   └── tip-server-typst/   # Binary tip-server-typst: main loop + handler wiring protocol to core
...
- `Handler` (tip-server-typst/src/handler.rs): dispatches protocol messages to core, sets project root from URI
